...
#Data processing
total_file = pd.read_excel("C:/Data/Studies/Projects/Amlan_sir/Low_hardness.xlsx")
...
#Genetic Programming
est_gp = SymbolicRegressor(population_size=5000, generations=200, tournament_size=50, const_range=(-1, 1), stopping_criteria=0.001,
                           init_depth=(2, 6), metric='rmse', function_set=['add', 'sub', 'mul', protectdiv, inverse],
                           p_crossover=0.7, p_subtree_mutation=0.05, p_hoist_mutation=0.05, parsimony_coefficient=0.00002,
...
if est_gp._program.raw_fitness_ > 0.14:
...
filename = "C:/Data/Studies/Projects/Amlan_sir/gp_model_low_hardness_1.pkl"
